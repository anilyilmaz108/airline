...
@Component({
  ...
  standalone: true,
  imports: [NzFormModule, CommonModule, NzInputModule, FormsModule, ReactiveFormsModule, NzButtonModule, NzModalModule],
...
export class EditProfileComponent {
  ...
  async submitForm() {
    ...
    await this.userService.update(this.id!, updateData).then(async () => {
